...
Java_com_libyuv_YuvUtils_compressYUV(JNIEnv *env, jclass type,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_libyuv_YuvUtils_cropYUV(JNIEnv *env, jclass type, jbyteArray src_, jint width,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_libyuv_YuvUtils_yuvI420ToNV21(JNIEnv *env, jclass type, jbyteArray i420Src,
                                           jbyteArray nv21Src,

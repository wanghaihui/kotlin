...
public interface WebSocketListener {
     ...
     *         The exception is passed to {@link #handleCallbackError(WebSocket, Throwable)}.
     */
    void onDisconnected(WebSocket websocket, WebSocketFrame serverCloseFrame, WebSocketFrame clientCloseFrame,
    ...
    /**
     * Called when a message failed to be decompressed -- 解压失败
     *
     * @param websocket The WebSocket.
     *
     * @param cause An exception that represents the error.

...
/**
 * DEFLATE (<a href="http://tools.ietf.org/html/rfc1951">RFC 1951</a>) decompressor implementation from scratch
 * 解压缩
 */
class DeflateDecompressor {
    ...
    private static void inflateData(ByteArray input, int[] bitIndex, ByteArray output,

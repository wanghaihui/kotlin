...
class HandshakeReader {
    ...
    private StatusLine readStatusLine(WebSocketInputStream input) throws WebSocketException {
        ...
        try {
            ...
            throw new WebSocketException(WebSocketError.OPENING_HANDSHAKE_RESPONSE_FAILURE,
        ...
        if (line == null || line.length() == 0) {
            ...
            throw new WebSocketException(WebSocketError.STATUS_LINE_EMPTY,
                    "The status line of the opening handshake response is empty.");
        }
        ...
        try {
            ...
            throw new WebSocketException(WebSocketError.STATUS_LINE_BAD_FORMAT,
    ...
    private Map<String, List<String>> readHttpHeaders(WebSocketInputStream input) throws WebSocketException {
        ...
        while (true) {
            try {
                ...
                throw new WebSocketException(WebSocketError.HTTP_HEADER_FAILURE,
    ...
    private void validateStatusLine(StatusLine statusLine, Map<String, List<String>> headers, WebSocketInputStream input) throws WebSocketException {
        ...
        throw new OpeningHandshakeException(WebSocketError.NOT_SWITCHING_PROTOCOLS,
    ...
    private void validateUpgrade(StatusLine statusLine, Map<String, List<String>> headers) throws WebSocketException {
        ...
        if (values == null || values.size() == 0) {
            ...
            throw new OpeningHandshakeException(WebSocketError.NO_UPGRADE_HEADER,
                    "The opening handshake response does not contain 'Upgrade' header.",
                    statusLine, headers);
        }
        ...
        throw new OpeningHandshakeException(WebSocketError.NO_WEBSOCKET_IN_UPGRADE_HEADER,
                "'websocket' was not found in 'Upgrade' header.",
                statusLine, headers);
    }
    ...
    private void validateConnection(StatusLine statusLine, Map<String, List<String>> headers) throws WebSocketException {
        ...
        if (values == null || values.size() == 0) {
            ...
            throw new OpeningHandshakeException(WebSocketError.NO_CONNECTION_HEADER,
                    "The opening handshake response does not contain 'Connection' header.",
                    statusLine, headers);
        }
        ...
        throw new OpeningHandshakeException(WebSocketError.NO_UPGRADE_IN_CONNECTION_HEADER,
                "'Upgrade' was not found in 'Connection' header.",
                statusLine, headers);
    }
    ...
    private void validateAccept(StatusLine statusLine, Map<String, List<String>> headers, String key) throws WebSocketException {
        ...
        if (!expected.equals(actual)) {
            ...
            throw new OpeningHandshakeException(WebSocketError.UNEXPECTED_SEC_WEBSOCKET_ACCEPT_HEADER,
                    "The value of 'Sec-WebSocket-Accept' header is different from the expected one.",
                    statusLine, headers);
        }
        ...
        for (String value : values) {
            ...
            for (String element : elements) {
                ...
                if (extension == null) {
                    ...
                    throw new OpeningHandshakeException(WebSocketError.EXTENSION_PARSE_ERROR,
                ...
                if (!mWebSocket.getHandshakeBuilder().containsExtension(name)) {
                    ...
                    throw new OpeningHandshakeException(WebSocketError.UNSUPPORTED_EXTENSION,
    ...
    private void validateProtocol(StatusLine statusLine, Map<String, List<String>> headers) throws WebSocketException {
        ...
        if (!mWebSocket.getHandshakeBuilder().containsProtocol(protocol)) {
            ...
            throw new OpeningHandshakeException(WebSocketError.UNSUPPORTED_PROTOCOL,
